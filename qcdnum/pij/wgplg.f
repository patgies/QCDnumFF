...
C   24/08/89 CERN SUBROUTINE WGPLG

      FUNCTION WGPLG(N,P,X)
* av: notation adapted to f2c (WGPLG*16 does not work)
      ...
      COMPLEX*16 V(0:5),SK,SM,WGPLG
* av: now WGPLG declared here
...
*mb   This is to suppress a compiler warning that B0 might be uninitialized
      B0 = 0.D0
