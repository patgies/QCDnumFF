...
set arrow from 0.001,-0.0001 to 0.9,-0.0001 nohead front lc 'grey'
plot 'bt02gx200x70.dat' using 1:5 with lines lc 'black',\
     'bt02gx200x50.dat' using 1:5 with lines lc 'red',\
     'bt02gx200x30.dat' using 1:5 with lines lc 'blue'

plot 'bt02sx200x70.dat' using 1:5 with lines lc 'black',\
     'bt02sx200x50.dat' using 1:5 with lines lc 'red',\
     'bt02sx200x30.dat' using 1:5 with lines lc 'blue'
unset multiplot
